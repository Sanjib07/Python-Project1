...
print("which is helping to print the statement or string.")
print('python is a popular language"now a days most of people using python is a programming language"')
print("About Python:\n\t1.Python is a programming language.\n\t2.It's very is to learn and understand\n\t3.people are so excited to learn python now a days")
